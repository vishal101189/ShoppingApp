...
export class AuthService {
   ...
   // user =new BehaviorSubject<User>(null);
    ...
    //https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=[API_KEY](google firebase restapi signup link and replace [API_KEY] with project api in firebase)
    ...
    private handleAuthentication(email: string, userId: string, token: string, expiresIn: number) {
        ...
        //Store date in User after successfully signup
       ...
       // this.user.next(user);
        ...
        //To set Data in localStorage and avoid the issue of reloading app
